...
Chat.prototype.addConsultant = function(socket , data) {
	debug("Подключился консультант" , data);
	this.consultants[socket.id]				={};
	this.consultants[socket.id]['socket'] 	= socket;
	this.consultants[socket.id]['info']		= {};
	this.consultants[socket.id]['info']		= data;
	
	this.io.to('consultants').emit('addConsultant' , data);
};
